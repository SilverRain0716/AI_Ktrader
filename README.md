...
> **단계가 순차적이지 않다.** 1·2 는 완료됐고 4 의 입력(컨텍스트 팩)까지 지어졌는데, **0 이 아직 열려 있다** — 키움 앱키 대기.
...
> Phase 0 실측 35칸 중 5칸을 채웠다([결과](docs/phase0-results.md)). 나머지는 키움 앱키가 필요하다.
>
...
| 단계 | 내용 | 상태 |
|---|---|---|
| 0 | 키움 REST 앱키 발급, 조건식·유량 제약 실측 | ⏳ **35칸 중 5칸** — 앱키 대기 |
